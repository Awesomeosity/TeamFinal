...
public:
	...
	* @param   Permissions The permissions the application is requesting (ex. "user_read user_subscriptions")
    * @param   ForceVerify Flag, if the authentication should be verified again.
    *
    * @return  The authentication URL.
    */
    static FString GetAuthenticationUrl(const FString& ClientId, const FString& Permissions, bool ForceVerify);
